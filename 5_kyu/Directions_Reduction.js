...
// Since this is the wild west, with dreadfull weather and not much water, it's important 
...
// You can immediatly see that going "NORTH" and then "SOUTH" is not reasonable, better stay 
...
// the final result is [] (nil in Clojure). In ["NORTH", "EAST", "WEST", "SOUTH", "WEST", "WEST"], 
// "NORTH" and "SOUTH" are not directly opposite but they become directly opposite after the 
...
function dirReduc(arr){
  var notAllowed = {"NORTH": "SOUTH", "SOUTH": "NORTH", "EAST": "WEST", "WEST": "EAST"}
  for(i=0; i<arr.length;) {
    if(arr[i+1] === notAllowed[arr[i]]) {
      arr.splice(i, 2);
      if(i>0) {
        i--;
      } else {
